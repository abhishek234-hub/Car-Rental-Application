...
const Register = () => {
  ...
  const { register, loginWithGoogle, API_URL } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!otpSent) {
      setError("Please request and enter the verification OTP code sent to your email.");
      return;
    }
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50/60 via-amber-50/40 via-orange-50/20 to-orange-100/40 dark:from-slate-950 dark:via-slate-900 dark:via-orange-950/20 dark:to-amber-950/20 text-slate-855 dark:text-slate-100 [perspective:1200px] transition-colors duration-300">

      {/* Glow */}
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-amber-300/20 dark:bg-amber-900/10 blur-[120px] rounded-full pointer-events-none animate-float"></div>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-orange-300/25 dark:bg-orange-900/10 blur-[120px] rounded-full pointer-events-none animate-float-delayed"></div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5 [transform:translateZ(15px)]">
          ...
          <div className="relative">
            <FaUser className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-sm" />
            <input
              type="text"
          ...
          {/* OTP Section */}
          <div className="space-y-3 p-4 bg-white/20 dark:bg-slate-950/20 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl">
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  disabled={!otpSent}
                  className="w-full bg-white/50 dark:bg-slate-955/50 border border-slate-200/85 dark:border-slate-800/85 rounded-xl py-3 pl-14 pr-4 text-slate-800 dark:text-slate-100 outline-none focus:bg-white dark:focus:bg-slate-900 focus:border-orange-500 font-semibold text-xs shadow-sm disabled:opacity-50"
                  required={otpSent}
                />
              </div>
              ...
              <button
                ...
                disabled={sendingOtp}
                className="px-4 py-3 bg-orange-600 dark:bg-orange-500 text-white font-bold text-[11px] uppercase tracking-wider rounded-xl transition disabled:opacity-50 cursor-pointer shadow-sm min-w-[100px]"
              >
            ...
            {otpMessage && (
              <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-black text-center uppercase tracking-wider">
                {otpMessage}
              </p>
            )}
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-orange-400 via-orange-500 to-amber-500 text-white font-bold shadow-md shadow-orange-500/20 hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer disabled:opacity-50"
          >
        ...
        <div className="[transform:translateZ(15px)]">
          <button
            ...
            className="w-full py-3.5 rounded-2xl bg-white dark:bg-slate-955 hover:bg-slate-50 dark:hover:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-all duration-300 flex items-center justify-center gap-2.5 font-bold text-xs shadow-sm cursor-pointer"
          >
        ...
        {/* Login */}
        <p className="text-center text-slate-505 dark:text-slate-400 mt-8 text-sm font-semibold [transform:translateZ(12px)]">
      ...
      <AnimatePresence>
        {showGoogleModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-slate-955/65 backdrop-blur-sm">
            <motion.div
            ...
            >
              ...
              <button
                ...
                className="absolute top-5 right-5 text-slate-400 dark:text-slate-505 hover:text-slate-650 dark:hover:text-slate-355 cursor-pointer"
              >
                <FaTimes />
              </button>
              ...
              <p className="text-center text-xs text-slate-455 dark:text-slate-400 mt-1.5 font-semibold">to continue to <span className="font-bold text-slate-700 dark:text-slate-200">RentX</span></p>
