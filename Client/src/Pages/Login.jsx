              ...
              {googleSubmitting ? (
                ...
                <div className="mt-8 space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3.5 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-955/40 border border-slate-100 dark:border-slate-800 transition duration-200 cursor-pointer text-left shadow-sm"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-orange-100 dark:bg-orange-950/40 flex items-center justify-center text-orange-700 dark:text-orange-300 text-sm font-black">
                        AM
                      </div>
                      <div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3.5 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-955/40 border border-slate-105 dark:border-slate-800 transition duration-200 cursor-pointer text-left shadow-sm"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-emerald-100 dark:bg-emerald-950/40 flex items-center justify-center text-emerald-700 dark:text-emerald-300 text-sm font-black">
                        RG
                      </div>
                      <div>
                        <p className="text-sm font-bold text-slate-808 dark:text-slate-100">Renter Guest</p>
